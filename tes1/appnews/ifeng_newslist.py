...
class ParseConf(object):
    ...
    def parse(self):
        ...
        self.toutiao_list_url = data["toutiao_list_url"]
...
class NewsListCollector(object):
    ...
    def __init__(self):
        ...
        parse_api = ParseConf()
        self.toutiao_list_url = parse_api.toutiao_list_url
    ...
    def Starter(self):
        self.cursor.execute("select channelId , channelName from channellist where appName = 'ifeng' and recommend > 0")
