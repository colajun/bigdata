...
def plotBestFit(dataSet1, dataSet2,dataSet3):
    dataArr1 = array(dataSet1)
    dataArr2 = array(dataSet2)
    dataArr3 = array(dataSet3)
    n = shape(dataArr1)[0]
    n1 = shape(dataArr2)[0]
    xcord1 = []
    ycord1 = []
...
if __name__ == '__main__':
    mata = loadDataSet('/home/hadoop/bigdata/workspacepython/bigdata/tes1/machinelearing/testSet.txt')
    a, b = pca(mata, 2)
    plotBestFit(a, b, mata)
