...
comment_table_name = "news360_comment_news_"+ time.strftime("%Y_%m")

news360_comment_table_create = "CREATE TABLE if not exists " + comment_table_name + "\
...
news360_comment_table_insert = "replace into " + comment_table_name + "(news_id, comment_id, user_from, agree_count, comment_time, comment_timestamp, content, parent_content) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)"
...
class IfengCommentCollector(object):
    ...
    def dbInit(self):
        ...
        self.cursor.execute(news360_comment_table_create)
